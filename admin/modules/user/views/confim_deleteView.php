...
<body>
    <div id="confim_delete" class="rounded bg-primary">
        <?php if (!empty($list_user_handle)) { ?>
        <h4 class="text-warning">Bạn có chắc là muốn xoá những user dưới đây ?</h4>
         <ul class="list_user">
        ...
        <form action="" method="POST">
            <button name="btn_confim_delete" value="delete" class="btn-danger rounded">Xoá</button>
