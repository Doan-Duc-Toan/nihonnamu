...
<body>
    <div id="confim_delete_forever" class="rounded">
        <?php if (!empty($list_user_handle)) { ?>
        <h4 class="text-warning">Bạn có chắc là muốn xoá <b  style="font-weight: 600; color: red">vĩnh viễn</b> những user dưới đây ?</h4>
         <ul class="list_user">
        ...
        <form action="" method="POST">
            <button name="btn_confim_delete_forever" value="delete" class="btn-danger rounded">Xoá</button>
